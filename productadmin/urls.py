...
urlpatterns = [
    ...
    re_path(r'api/dashboard/shipping/get_region_list/$', views.getRegionListAPI.as_view(), name='getRegionList'),
    ...
    re_path(r'updatedropdown/(?P<pk>\d+)/$', views.updateDropDownOption.as_view(), name='updatedropdownprod'),
